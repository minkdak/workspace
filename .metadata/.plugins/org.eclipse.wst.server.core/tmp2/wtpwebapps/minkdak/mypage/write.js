...
//			$('#p_save_btn').click(function() {
			...
			if (photo[i].length == 2) {
			    ...
			    .html("<div  class='two_photo_col 2-collage' id='collage2-1-count" +countPhoto +"'><img id='img_4' src=''></div>"
			     ...
			     $('#collage2-1-count'+ countPhoto +'> img').attr('src', photo[i][0].path + "_500.png").css('width', '534px').css('height','534px');
			     $('#collage2-2-count'+ countPhoto +'> img').attr('src', photo[i][1].path + "_500.png").css('width', '534px').css('height','534px');
...
//		    console.log("지워진다")
//				if(countPhoto == 0) {
//				  $('.TP-collage-'+countPhoto).remove()
//		
//				  } else {
				delPhotoTransm()
//				  }
//				console.log($('#text_parent_'+countPhoto).parent())
