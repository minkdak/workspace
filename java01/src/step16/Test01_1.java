...
public class Test01_1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // => 문제는 ..을 잘못사용하여 존재하지 않는 디렉토리 경로가 나왔을 때, 
    //    예외를 던진다.
    ...
    System.out.printf("getTotlaSpace() = %d\n", f.getTotalSpace());
    ...
    // isFile()
    // => File 객체가 가리키는 경로가 파일인지 리턴한다.
    System.out.printf("isFilse() = %b\n", f.isFile());
