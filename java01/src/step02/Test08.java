...
public class Test08 {
  ...
  public static void main(String[] args) {
    ...
    byte[] arr1 = new byte[3]; // 메모리는 차지하고 있지만 주소는 찾을 수 없다. 
    ...
    //arr1 = new byte[5]{40, 50, 60, 70, 80}; 방의 개수를 지정하면 안된다. 오류!
    System.out.printf("%d, %d, %d, %d, %d\n", arr1[0], arr1[1], arr1[2], arr1[3], arr1[4]);
    
    byte[] arr2;
    arr2 = new byte[]{10,20, 30, 40};
     ...
     *    이렇게 쓰레기를 정리해 주는 프로그램을 "쓰레기 수집차(Garbage Collector)"라 부른다.
     *    
     *Dangling Pointer
