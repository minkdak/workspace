 ...
 * => 인스턴스(=객체)를 다루는 메서드는 그 인스턴스와 관련되
 *    클래스 블록 안에 둔다.
...
public class Test01_3 {
  static class Student {
    ...
    // 이렇게 클래스 블록안에 묶인 메서드를 호출할 때 마다 클래스 이름으로
    // 호출해야 하는 메서드를 "클래스 메서드(= 스태틱 메서드)"라 부른다.
    // 개발자들은 스태틱 메서드라고 많이 부르지만 공식적으로는 클래스 메서드라고 표현한다.
  ...
  public static void main(String[] args) {
    ...
    // init(), compute(), print() 메서드는 Student 클래스 블록안에 묶여있기 때문에
