...
public class Test07_10 {
  ...
  static class MyKey {
    ...
    public String toString() { // 해시코드 밸류 출력
      return value;
    }
    @Override
    public int hashCode() {
  ...
  public static void main(String[] args) {
    ...
    // for
    for (Object value : valueList) { // Collection 타입이기 때문에 바로 key로 돌려도된다.
    ...
    //    Collection에 있는 값을 꺼낼 때 for( : ) 문법을 사용할 수 있다.
