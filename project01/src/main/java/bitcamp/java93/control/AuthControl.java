...
public class AuthControl {
  ...
  public String login(String userType, String email, String password, String saveEmail, Model model, HttpServletResponse response) throws Exception {
      Member member = null; 
      ...
      if (member != null) { 
        ...
        if (saveEmail != null) { 
          ...
          response.addCookie(cookie2); // 얘는 응답헤더에 할 수 밖에없어서 HttpSErvletResponse 써야됨.어쩔수없다.
        } else {
