...
6) JSP 액션 태그
   ...
   - class 속성: 변수의 타입. 보관소에 객체가 없으면 이 클래스의 인스턴스를 생성함.
                import를 했는지 여부와 상관없이 반드시 전체 클래스 이름을 적어야한다.
   - scope: 객체를 꺼내는 보관소를 가리킴. 기본이 PageContext이다.
...
<%-- 
위의 코드는 다음과 비슷한 자바 코드를 생성한다.
java.util.List list = (java.util.ArrayList)PageContext.getAttribute("list");
if (list == null) {
