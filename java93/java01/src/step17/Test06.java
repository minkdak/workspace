 ...
 * => 그래서 작성할 때 주의해야 한다.
 *    여러 개의 catch 문이 있을 때,
 *    최하위 클래스를 파라미터로 갖는 catch 문부터 작성하라.
 *    왜?
 *    다형성의 다형적 변수 규칙상,
...
public class Test06 {
  public static void main(String[] args) {
    ...
    } catch (NumberFormatException e) { // numberformat이면 이거
      System.out.println("애플리케이션의 아규먼트 숫자가 아닙니다.");
      
    } catch (Exception e) {
      System.out.println("나이 값이 유효하지 않습니다.");
      
    } catch (Throwable ex) { // 다른 throwable 객체는 이거실행
