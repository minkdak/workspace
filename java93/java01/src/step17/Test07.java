 ...
 * => 그런데 예외 상황에 맞는 마땅한 예외 클래스가 없을 경우,
 *    또는 예외가 발생했을 때 좀 더 잘 표현하고 싶을 경우
 *    개발자가 직접 예외 클래스를 만들어 던질 수 있다.
 * => 이 때 그 클래스는 애플리케이션 예외이어햐 하기 때문에 
