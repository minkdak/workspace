/*  유틸리티 클래스 : java.util.Data 클래스와 import 명령문 II 
 * => import를 사용하여 클래스 정보를 명시할 때,
 *    와일드 카드(*)를 사용할 수 있다.
 * => 와일드 카드(*)를 사용한 import 명령문이 여러 개 있을 경우,
 *    개발자는 어떤 클래스가 어떤 패키지에 있는 클래스인지 직관적으로 알 수 없다.
...
// import는 반드시 package 명령 다음에 와야 한다.
import java.util.*;
import java.net.*;
import java.awt.*;
...
public class Test05_4 { 
  ...
  public static void main(String[] args) {
    ...
    System.out.println(today.getMonth() + 1); // 값의 범위가 0부터 11까지이다. 0이 1월이니까 +1 하면 정상출력
