...
public class Test06 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(3.14f); // 소문자 f를 더많이 사용
    ...
    /* 
     * 그래서 부동소수점의 최소 음수 값과 최대 양수 값은?
     *=> 부동소수점에서 소수점을 떼어낸 수의 자릿수가 6자리면 
     *4바이트 메모리에 정확하게 들어갈 수 잇다.
     *=> 부동소수점에서 소수점을 뗴어낸 수의 자릿수가 15자리면
     */
...
그래서 부동소수점의 최소 음수 값과 최대 양수 값은?
=> 부동소수점에서 소수점을 떼어낸 수의 자릿 수가 6자리면 
   4바이트 메모리에 정확하게 들어갈 수 있다.
   "유효자릿수가 7자리"
=> 부동소수점에서 소수점을 떼어낸 수의 자릿 수가 15자리면
   8바이트 메모리에 정확하게 들어갔 수 있다.
   "유효자릿수 15자리"
*/
