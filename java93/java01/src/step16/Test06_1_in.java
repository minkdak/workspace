...
public class Test06_1_in {
  ...
  public static void main(String[] args) throws Exception {
    ...
    // 바이트(바이너리) 스트링 클래스는 바이트 단위로 그대로 읽고 쓴다.
    while ((b = in.read()) != -1) {
    ...
    // 캐릭터 스트링 클래스는 문자 단위로 데이터를 읽고 쓴다.
    // 1) 읽을 때
    ...
    //       운영체제느 MS949(MS windows)나 UTF-8(Unix)을 사용하기 때문이다.
    //       즉 JVM 환경과 OS환경에서 문자코드를 다루는 방식이 다르기 때문이다.
    //       그래서 항식 변환이 필요하다.
    //
