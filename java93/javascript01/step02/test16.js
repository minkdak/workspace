...
// if (x == undefined) console.log("x는 undefined이다."); // 실행오류!
...
var v1 = 20;
v1 = undefined; // 존재하는 변수를 undefined로 만들 수 있다. 타입이 없는 상태로 만들 수 있다
...
if (v1 == undefined) console.log("v1는 false로 바뀐다.");
...
// 해결책? NaN의 상태를 알고 싶다면, 특별한 함수를 사용해야 한다.
