...
왜? prototype에는 인스턴스에 대해서는 작업을 수행하는 함수를 두는 장소이기 때문이다.
...
//      아무래도 서로 관련된 함수끼리 모아두는 것이 유지보수에 좋다.ㅣ
//      이런경우
//      서로 관련된 함수끼리 모아두고 싶고, 그러나 인스턴스를 사용하는 것이 아닐 때
//      prototype 객체에 보관하지말고, "함수 객체"에 바로 보관하라!
