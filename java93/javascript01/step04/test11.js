...
- 간단한 함수인 경우는 arrow 함수를 이용하여 짧게 파라미터로 넘길 수 있다.
*/
"use strict"
...
// 함수의 이름이 함수에 주소를 저장한 변수 이다.
function plus(a, b) {
  return a + b;
} // 얘는 바로 호출 할 수 있음(아래거랑 이 차이 뿐 역할은 같음)
...
// 함수를 호출하는 문장은 다음 문장과 구별이 되기 때문에 보통 세메콜론9;)을 생략한다.
...
// 함수에 들엉 ㅣㅆ는 명령문이 한 개 일 때는 블록{}을 생략할 수 있다.
// 블록을 생략했을 때는 값을 return하기 위해 return을 사용하지 말아야한다.
//
caller((a,b)) => return a + b);
*/
